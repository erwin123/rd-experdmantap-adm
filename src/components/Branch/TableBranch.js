...
const columnData = [
    ...
    { id: 'BranchName', numeric: false, disablePadding: false, label: 'BranchName' },
    { id: 'BranchCity', numeric: false, disablePadding: false, label: 'BranchCity' },
];
...
export default withStyles(styles)(TableBranch);