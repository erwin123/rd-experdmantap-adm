                ...
                {this.state.feedback
                    ...
                    .map(j => {
                        return (<div key={j.KdFeedback} style={{ borderBottom: "#fff solid 1px", padding: "5px", backgroundColor: "#c8e4fb" }}>
                            <div style={{ fontSize: "10px", fontWeight: "bold" }}>{j.CreatedBy} <span style={{ fontSize: "10px", fontWeight: "normal", fontStyle: "italic", color: "#7f7f7f" }}> pada {dt(j.CreatedDate)}</span></div>
