...
import Tablestaytune from './Tablestaytune';
    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                <StayTuneDialog showdialog={this.state.showdialog} closeIt={(close) => this.handleCloseDialog(close)}
...
class StayTuneDialog extends Component {
                ...
                >
                    ...
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Feedback<br />
                            <textarea rows="7" disabled={this.state.lock} onChange={(e) => this.handleChange(e)} name="feedback" style={{ width: "380px" }} value={this.state.feedback}></textarea>
...
export default withStyles(styles)(Staytune);